...
public class ToDo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Connection connection = DriverManager.getConnection("jdbc:hsqldb:db2", "sa", "");

        // launch HSQL Database GUI
        // org.hsqldb.util.DatabaseManagerSwing.main(new String[] { "--noexit", "--url", "jdbc:hsqldb:db2" });
    ...
    private static Connection setupDb(Connection connection) throws ClassNotFoundException, SQLException {
        ...
        // st.execute("CREATE TABLE TASKS ( id INTEGER IDENTITY, description VARCHAR(256), complete INTEGER, username VARCHAR(256) )");
